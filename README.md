### Hi, I'm Puran! 👋
- 🔭  I have two master's degrees in computer science (Upenn) and financial mathematics (USC) and a bachelor's degree in statistics (USTC) with 2-year working exporsure on data mining and full-life machine learning model deployment(including data pipeline, created APIs, testing, dashboard, flask app) on both structured and unstructured data in financial & tech industry. Yep, I transfer my career in quantitative finance industry to machine learning engineer <br>
